...
public class BookDAO{
    public ArrayList<Book> getAllBooks() throws SQLException, NamingException{
        Connection con = null;
    ...
    public boolean createBook(Book b) throws SQLException, NamingException{
        Connection con = null;
        PreparedStatement ps = null;
    ...
    public Book getBookByID(String id) throws SQLException, NamingException{
        Connection con = null;
        PreparedStatement ps = null;
        ResultSet rs = null;
    ...
    public boolean updateBook(Book b) throws SQLException, NamingException{
        Connection con = null;
        PreparedStatement ps = null;
    ...
    public ArrayList<Book> getBooksByCategory(String catID) throws SQLException, NamingException{
